...
/**
 * Examples
 *  This file gives a number of working examples for the PHP Client Library
 *  To use them, first enter your API key and Secret in this file
 *  Then, uncomment one of the examples and execute the file in Apache
 */
